# Ontology Documentation — SpecForge Studio

This folder defines the entity model, ID system, relationships, traceability, and status lifecycles for the entire platform (phase 02).
...
Draft — pending review as part of the ontology phase. Decisions made here are recorded in `memory/DECISIONS.md` (see DEC-002).
