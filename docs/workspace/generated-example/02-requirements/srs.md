...
### REQ-0001 — Customers can browse the product catalog

- Type: functional · Priority: must · Criticality: critical · Status: `approved`

Description: Browse, search, and filter published products with pagination.

Acceptance criteria: Acceptance criteria recorded in the test plan.


### REQ-0002 — Customers can complete checkout

- Type: functional · Priority: must · Criticality: critical · Status: `approved`

Description: Checkout with cart review, shipping address, and order confirmation.

Acceptance criteria: Acceptance criteria recorded in the test plan.


### REQ-0003 — Order totals are calculated server-side
